      ...
      const messages: MessagesType = [
            {
                  ...
                  Generate at max 3 questions that will help in understanding the requirements for creating a blog post. this is to help us understand the user expactiation from the blog. The questions should explore the depth of information required but should be simple to be ansrable by 6 year old boy. Please format the output as a JSON that matches the following structure for each question
            ...
            {
                  role: "user",
                  content: `Keep in mind that the questions should be related to topic:${prompt} and can be asnwered by 6 year old and aim of the question is to help us understand the user expactiation from the blog`,
            },
            {
                  role: "system",
